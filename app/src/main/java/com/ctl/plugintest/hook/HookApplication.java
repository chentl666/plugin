...
public class HookApplication extends Application {
    ...
    private static final String ACTIONINTENT = "HookApplication.actionIntent";
                ...
                new InvocationHandler() { // IActivityManager 接口的回调方法
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        ...
                        if ("startActivity".equals(method.getName())) {
                            ...
                            Intent intent = new Intent(HookApplication.this, HookProxyActivity.class);
     ...
     * Hook LunchActivity
     */
    private void hookLunchActivity() throws Exception {
