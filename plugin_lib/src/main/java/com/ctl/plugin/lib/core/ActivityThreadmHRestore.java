...
import com.ctl.plugin.lib.utils.AndroidSdkVersion;
import com.ctl.plugin.lib.utils.Parameter;
...
public class ActivityThreadmHRestore {
    ...
    public static void mActivityThreadmHAction(Context context) throws Exception {
        if (AndroidSdkVersion.isAndroidOS_26_27_28()) {
            do_26_27_28_mHRestore(context);
        } else if (AndroidSdkVersion.isAndroidOS_21_22_23_24_25()) {
            do_21_22_23_24_25_mHRestore(context);
        } else {
     ...
     * 高版本 》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》
     */
    private final static void do_26_27_28_mHRestore(Context context) throws Exception {
        // @1 怎么得到？ 看源码..
        ...
        mCallbackField.set(mH, new Custom_26_27_28_Callback(context));
    }
    ...
    private static class Custom_26_27_28_Callback implements Handler.Callback {
        ...
        public Custom_26_27_28_Callback(Context context) {
...
//                        CustomLoadedApkAction.hookGetPackageInfo(context, mLaunchActivityItem, targetIntent);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private final static void do_21_22_23_24_25_mHRestore(Context context) throws Exception {
        Class mActivityThreadClass = Class.forName("android.app.ActivityThread");
        ...
        // @1    @2
        mCallbackFile.set(mH, new Custom_21_22_23_24_25_Callback(context));
    }
    ...
    private static final class Custom_21_22_23_24_25_Callback implements Handler.Callback {
        ...
        public Custom_21_22_23_24_25_Callback(Context context) {
            this.context = context;
        }
...
//                        CustomLoadedApkAction.hookGetPackageInfo(context, mActivityClientRecord, targetIntent);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
